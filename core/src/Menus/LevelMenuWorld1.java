...
public class LevelMenuWorld1 implements Screen {
   ...
   public LevelMenuWorld1(RedMan2D game){
       this.game = game;
    ...
    public void show() {
        ...
        //label
        Label worldText = new Label("World 1",new Label.LabelStyle(new BitmapFont(), Color.WHITE) );
        ...
        forwardButton.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                dispose();
                ((RedMan2D)Gdx.app.getApplicationListener()).setScreen(new LevelMenuWorld2(game));
            }
        });
        ...
        levelTable.add(forwardButton).center().expandX().padTop(20);
